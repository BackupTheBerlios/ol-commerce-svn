<?php
/* --------------------------------------------------------------
$Id: auctions_list_plan.php,v 1.1.1.1.2.1 2007/04/08 07:16:25 gswkaiser Exp $
...
//show all auctions sheduled
$mynewstarttime = toGMT(date(AUCTIONS_DATE_FORMAT));
$auctionssql = SELECT_ALL.TABLE_AUCTION_LIST." where starttime > '".$mynewstarttime.
"' ORDER BY auction_list.starttime";
...
$page_header_subtitle=AUCTIONS_TEXT_SUB_HEADER_AUCTION_LIST_PLANNED;
