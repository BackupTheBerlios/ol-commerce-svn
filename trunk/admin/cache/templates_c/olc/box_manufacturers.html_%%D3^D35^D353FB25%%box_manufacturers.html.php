<?php /* Smarty version 2.6.18, created on 2007-10-10 13:48:34
         compiled from olc/boxes/box_manufacturers.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'olc_template_init', 'olc/boxes/box_manufacturers.html', 2, false),)), $this); ?>
...
<table width="100%" class="<?php echo $this->_tpl_vars['box_navigation_area']; ?>
 box_MANUFACTURERS" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><h3><?php echo $this->_config[0]['vars']['heading_manufacturers']; ?>
</h3></td>
	</tr>
  <tr>
    <td class="infoBox">
