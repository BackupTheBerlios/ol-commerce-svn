...
var Coordinates = {
	...
	RePosition : function(mouse,element)
	{
		element.style.left = mouse.x + Drag.scrollX + "px";
		element.style.top = mouse.y + Drag.scrollY + "px";
	},
...
Coordinate.prototype.reposition = function(element)
{
	...
	*/
//if (Drag.scrollX!=0 || Drag.scrollY!=0) var tx=document.getElementsById("XX");		//Wrong statement to force debugger activation!!!!
	element.style.left = this.x + Drag.scrollX + "px";
	element.style.top = this.y + Drag.scrollY + "px";
}
