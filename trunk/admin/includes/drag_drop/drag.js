...
var Drag = {
	...
	onMouseDown : function(event)
	{
		...
		if (target.className!='NoMouseDown')
		{
	...
	showStatus : function(mouse, nwPosition, sePosition, nwOffset, seOffset) {
		...
		"NW Abstand: " + nwOffset.toString() + "    " +
		"SE Abstand: " + seOffset.toString();
		/*
		*/
	},

	set_scroll_values : function(event)
	{
		//Check for scrolled screen
		with (document)
		{
			if (document.all)
			{
				with (body)
				{
					...
					if (document_Element.scrollLeft!=null)
					{
						scrollX = document_Element.scrollLeft;
						scrollY = document_Element.scrollTop;
					}
					else
					{
						scrollX = scrollLeft;
	...
	onMouseMove : function(event)
	{
		...
		group.onDrag(mouse,nwPosition, sePosition, nwOffset, seOffset);
