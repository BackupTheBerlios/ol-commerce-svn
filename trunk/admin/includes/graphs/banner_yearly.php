<?php
/* --------------------------------------------------------------
   $Id: banner_yearly.php,v 1.1.1.1.2.1 2007/04/08 07:16:45 gswkaiser Exp $   
...
(c) 2004      XT - Commerce; www.xt-commerce.com
  ...
  $banner_stats_query = olc_db_query("select year(banners_history_date) as year, sum(banners_shown) as value, sum(banners_clicked) as dvalue from " . TABLE_BANNERS_HISTORY . " where banners_id = '" . $banner_id . "' group by year");
