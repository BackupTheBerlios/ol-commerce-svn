<?php
/* -----------------------------------------------------------------------------------------
   $Id: preissuchmaschine.php,v 1.1.1.1 2006/12/22 13:39:12 gswkaiser Exp $
...
define('MODULE_PREISSUCHMASCHINE_TEXT_DESCRIPTION', 'Export - Preissuchmaschine (; getrennt)<br/><b>Format:</b><br/>Bezeichnung;Artikelnummer;Preis; Produktbeschreibung;Lieferstatus;Produktlink; FotoLink');
define('MODULE_PREISSUCHMASCHINE_TEXT_TITLE', 'Preissuchmaschine - CSV');
define('MODULE_PREISSUCHMASCHINE_FILE_TITLE' , '<hr noshade="noshade"/>Dateiname');
...
define('MODULE_PREISSUCHMASCHINE_CURRENCY_TITLE','Währung');
define('MODULE_PREISSUCHMASCHINE_CURRENCY_DESC','Welche Währung soll exportiert werden?');
...
// include needed functions
  ...
  class preissuchmaschine {
    ...
    function preissuchmaschine() {
      ...
      $this->enabled = ((MODULE_PREISSUCHMASCHINE_STATUS == TRUE_STRING_S) ? true : false);
    ...
    return array('text' =>  EXPORT_STATUS_TYPE.HTML_BR.
                            ...
                            HTML_A_START . olc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $_GET['set'] . '&module=preissuchmaschine') . '">' .
    ...
    function check() {
      if (!isset($this->_check)) {
        $check_query = olc_db_query("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_PREISSUCHMASCHINE_STATUS'");
    ...
    function install() {
      olc_db_query(INSERT_INTO . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PREISSUCHMASCHINE_FILE', 'preissuchmaschine.csv',  '6', '1', '', now())");
      olc_db_query(INSERT_INTO . TABLE_CONFIGURATION . " (configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PREISSUCHMASCHINE_STATUS', 'true',  '6', '1', 'olc_cfg_select_option(array(\'True\', \'False\'), ', now())");
}
