...
define('MODULE_GEIZHALS_TEXT_DESCRIPTION', 'Export - Geizhals (; getrennt)<br/><b>Format:</b><br/>Artikelnr;Hersteller;Bezeichnung;Preis; Verfügbarkeit;deeplink;optionale Beschreibung');
...
// include needed functions
  ...
  class geizhals {
    ...
    function process($file) {
        ...
        $schema = 'Artikelnr;Hersteller;Bezeichnung;Preis;Verfügbarkeit;deeplink;optionale Beschreibung' . NEW_LINE;
