<?php
/* --------------------------------------------------------------
   $Id: html_graphs.php,v 1.1.1.1.2.1 2007/04/08 07:16:43 gswkaiser Exp $   
...
(c) 2004      XT - Commerce; www.xt-commerce.com
  ...
  function start_graph($vals, $names) {
    ...
    if ( ($vals['vlabel']) || ($vals['hlabel']) ) {
      ...
      $start_graph_string .= '  <tr>' . NEW_LINE .
                             '    <td align="center" valign="center"';

      // if a background was choosen don't print cell BGCOLOR
      if (!$vals['background']) $start_graph_string .= ' bgcolor="' . $vals['hbgcolor'] . '"';

      $start_graph_string .= ' colspan="' . $colspan . '"><font color="' . $vals['hfcolor'] . '" style="' . $vals['hfstyle'] . '"><b>' . $vals['hlabel'] . '</b></font></td>' . NEW_LINE .
                             '  </tr>' . NEW_LINE .
                             '  <tr>' . NEW_LINE .
                             '    <td align="center" valign="center"';
      ...
      $start_graph_string .=  ' rowspan="' . $rowspan . '"><font color="' . $vals['vfcolor'] . '" style="' . $vals['vfstyle'] . '"><b>' . $vals['vlabel'] . '</b></font></td>' . NEW_LINE .
                              '  </tr>' . NEW_LINE;
    }
  ...
  function horizontal_graph($names, $values, $bars, $vals) {
    ...
    for($i = 0, $n = sizeof($values); $i < $n; $i++) { 
      $horizontal_graph_string .= '  <tr>' . NEW_LINE .
                                  '    <td align="right"';
      // if a background was choosen don't print cell BGCOLOR
      if (!$vals['background']) $horizontal_graph_string .= ' bgcolor="' . $vals['namebgcolor'] . '"';

      $horizontal_graph_string .= '><font size="-1" color="' . $vals['namefcolor'] . '" style="' . $vals['namefstyle'] . '">' . $names[$i] . '</font></td>' . NEW_LINE .
                                  '    <td'; 
      ...
      if (ereg('^#', $bars[$i])) { 
        $horizontal_graph_string .= '<table cellpadding="0" cellspacing="0" bgcolor="' . $bars[$i] . '" width="' . ($values[$i] * $vals['scale']) . '">' . NEW_LINE .
                                    '  <tr>' . NEW_LINE .
                                    '    <td>&nbsp;</td>' . NEW_LINE .
                                    '  </tr>' . NEW_LINE .
                                    '</table>';
      ...
      $horizontal_graph_string .= '</td>' . NEW_LINE .
                                  '  </tr>' . NEW_LINE;
    } // endfor
  ...
  function vertical_graph($names, $values, $bars, $vals) {
    $vertical_graph_string = '  <tr>' . NEW_LINE;
    ...
    for ($i = 0, $n = sizeof($values); $i < $n; $i++) {
      ...
      $vertical_graph_string .= '"></td>' . NEW_LINE;
    } // endfor
    ...
    for ($i = 0, $n = sizeof($values); $i < $n; $i++) {
      ...
      $vertical_graph_string .= '><font size="-1" color="' . $vals['namefcolor'] . '" style="' . $vals['namefstyle'] . '">' . $names[$i] . '</font></td>' . NEW_LINE;
    } // endfor
  ...
  function double_horizontal_graph($names, $values, $bars, $vals, $dvalues, $dbars) {
    ...
    for($i = 0, $n = sizeof($values); $i < $n; $i++) {
      $double_horizontal_graph_string .= '  <tr>' . NEW_LINE .
                                        '    <td align="right"';

      // if a background was choosen don't print cell BGCOLOR
      if (!$vals['background']) $double_horizontal_graph_string .= ' bgcolor="' . $vals['namebgcolor'] . '"';

      $double_horizontal_graph_string .= '><font size="-1" color="' . $vals['namefcolor'] . '" style="' . $vals['namefstyle'] . '">' . $names[$i] . '</font></td>' . NEW_LINE .
                                         '    <td';

      // if a background was choosen don't print cell BGCOLOR
      if (!$vals['background']) $double_horizontal_graph_string .= ' bgcolor="' . $vals['valuebgcolor'] . '"';

      $double_horizontal_graph_string .= '><table align="left" cellpadding="0" cellspacing="0" width="' . ($dvalues[$i] * $vals['scale']) . '">' . NEW_LINE .
                                         '      <tr>' . NEW_LINE .
                                         '        <td';
      ...
      // decide if the value in bar is a color code or image.
      if (ereg('^#', $bars[$i])) { 
        $double_horizontal_graph_string .= '<table align="left" cellpadding="0" cellspacing="0" bgcolor="' . $bars[$i] . '" width="' . ($values[$i] * $vals['scale']) . '">' . NEW_LINE .
                                           '  <tr>' . NEW_LINE .
                                           '    <td>&nbsp;</td>' . NEW_LINE .
                                           '  </tr>' . NEW_LINE .
                                           '</table>';
      ...
      $double_horizontal_graph_string .= '</nowrap></td>' . NEW_LINE .
                                         '        </tr>' . NEW_LINE .
                                         '      </table>';
      ...
      $double_horizontal_graph_string .= '</td>' . NEW_LINE .
                                         '  </tr>' . NEW_LINE;
    } // endfor
  ...
  function double_vertical_graph($names, $values, $bars, $vals, $dvalues, $dbars) {
    $double_vertical_graph_string = '  <tr>' . NEW_LINE;
    for ($i = 0, $n = sizeof($values); $i < $n; $i++) {
      ...
      $double_vertical_graph_string .= '><table>' . NEW_LINE .
                                       '      <tr>' . NEW_LINE .
      ...
      $double_vertical_graph_string .= '"></td>' . NEW_LINE .
                                       '        <td align="center" valign="bottom"';
    ...
    for ($i = 0, $n = sizeof($values); $i < $n; $i++) {
      ...
      $double_vertical_graph_string .= '><font size="-1" color="' . $vals['namefcolor'] . '" style="' . $vals['namefstyle'] . '">' . $names[$i] . '</font></td>' . NEW_LINE;
    } // endfor
  ...
  function olc_banner_graph_infoBox($banner_id, $days) {
    $banner_stats_query = olc_db_query("select dayofmonth(banners_history_date) as name, banners_shown as value, banners_clicked as dvalue from " . TABLE_BANNERS_HISTORY . " where banners_id = '" . $banner_id . "' and to_days(now()) - to_days(banners_history_date) < " . $days . " order by banners_history_date");
  ...
  ////
  // draws a double vertical bar graph for the banner views vs clicks statistics
  function olc_banner_graph_yearly($banner_id) {
    global $banner;

    $banner_stats_query = olc_db_query("select year(banners_history_date) as year, sum(banners_shown) as value, sum(banners_clicked) as dvalue from " . TABLE_BANNERS_HISTORY . " where banners_id = '" . $banner_id . "' group by year(banners_history_date)");
    while ($banner_stats = olc_db_fetch_array($banner_stats_query)) {
  ...
  ////
  // draws a double vertical bar graph for the banner views vs clicks statistics
  function olc_banner_graph_monthly($banner_id) {
    global $banner;
    ...
    $banner_stats_query = olc_db_query("select month(banners_history_date) as banner_month, sum(banners_shown) as value, sum(banners_clicked) as dvalue from " . TABLE_BANNERS_HISTORY . " where banners_id = '" . $banner_id . "' and year(banners_history_date) = '" . $year . "' group by month(banners_history_date)");
    while ($banner_stats = olc_db_fetch_array($banner_stats_query)) {
