...
<input type="button" value="<?php echo $l->m('ok')?>" onclick="javascript:okClick()" class="bt">
<input type="button" value="<?php echo $l->m('cancel')?>" onclick="javascript:cancelClick()" class="bt"><br><br>
</form>
</p>
