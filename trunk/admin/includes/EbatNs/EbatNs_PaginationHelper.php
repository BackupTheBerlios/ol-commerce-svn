<?php
// $Id: EbatNs_PaginationHelper.php,v 1.1.1.1.2.1 2007/04/08 07:16:39 gswkaiser Exp $
		...
		function getNextPage()
		{
			...
			else
			{
				...
				if ($this->_maxEntries > 0)
				{
					...
					{
						// echo "<br/>checking (handler) " . $this->_proxy->getPaginationCounter() . " to " . $this->_maxEntries . HTML_BR;
					...
					{
						// echo "<br/>checking (attach-mode) " . $this->_proxy->getPaginationCounter() . " to " . $this->_maxEntries . HTML_BR;
