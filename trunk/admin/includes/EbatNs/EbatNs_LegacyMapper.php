<?php 
// $Id: EbatNs_LegacyMapper.php,v 1.1.1.1.2.1 2007/04/08 07:16:39 gswkaiser Exp $
 ...
 * @version $Id: EbatNs_LegacyMapper.php,v 1.1.1.1.2.1 2007/04/08 07:16:39 gswkaiser Exp $
 * @access public 
 */
class EbatNs_MapExpression
{
	...
	{ 
		// echo "evalExpression " . $this->_expression . HTML_BR;
...
class EbatNs_MapTarget
{
	...
	function parse($target)
	{
		...
		// echo "need Parse target " . $target . HTML_BR;
	} 
} 
...
class EbatNs_LegacyMapper
{
	...
	function SoapBoolean($value)
	{
		...
		{
			if ($value)
				return TRUE_STRING_S;
			else
				return FALSE_STRING_S;
		} 
		else
			return $value;
	} 
