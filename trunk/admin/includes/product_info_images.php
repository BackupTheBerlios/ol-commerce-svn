<?php
/* --------------------------------------------------------------
$Id: product_info_images.php,v 1.1.1.1.2.1 2007/04/08 07:16:38 gswkaiser Exp $
...
$a = new image_manipulation($image_path,PRODUCT_IMAGE_INFO_WIDTH,PRODUCT_IMAGE_INFO_HEIGHT,
DIR_FS_CATALOG_INFO_IMAGES . $products_image_name,IMAGE_QUALITY,EMPTY_STRING);
...
{
	$string=str_replace(APOS,EMPTY_STRING,PRODUCT_IMAGE_INFO_MERGE);
