<?php
/* --------------------------------------------------------------
   $Id: server_info.php,v 1.1.1.1.2.1 2007/04/08 07:16:31 gswkaiser Exp $   
...
(c) 2004      XT - Commerce; www.xt-commerce.com
  ...
  $system = olc_get_system_information();
?>
          ...
          <tr>
            <td align="center"><table border="0" cellspacing="0" cellpadding="3">
              <tr>
                ...
                <td class="smallText"><?php echo $system['host'] . LPAREN . $system['ip'] . RPAREN; ?></td>
                <td class="smallText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo TITLE_DATABASE_HOST; ?></b></td>
                <td class="smallText"><?php echo $system['db_server'] . LPAREN . $system['db_ip'] . RPAREN; ?></td>
              </tr>
              <tr>
                <td class="smallText"><b><?php echo TITLE_SERVER_OS; ?></b></td>
                <td class="smallText"><?php echo $system['system'] . BLANK . $system['kernel']; ?></td>
              ...
              <tr>
                <td colspan="4"><?php echo olc_draw_separator('pixel_trans.gif', '1', '5'); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3" class="smallText"><?php echo $system['php'] . LPAREN . TITLE_ZEND_VERSION . BLANK . $system['zend'] . RPAREN; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
