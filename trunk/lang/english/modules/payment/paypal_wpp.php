...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_DP_TEXT_BUTTON_TEXT', 'Save time. Checkout securely. Pay without sharing your financial information.');
...
define('PAYPAL_DP_STATUS_PENDING','Pending');
define('MODULE_PAYMENT_PAYPAL_DP_CC_TEXT', " (%s or %s)");
?>
