<?php
/*------------------------------------------------------------------------------
   $Id: affiliate_payment.php,v 2.0.0 2006/12/14 05:48:30 gswkaiser Exp $
...
define('EMAIL_TEXT_STATUS_UPDATE', 'Your payment has been updated to the following status.' . "\n\n" . 'New status: %s' . "\n\n" . 'Please reply to this email if you have any questions.' . NEW_LINE);
define('EMAIL_TEXT_NEW_PAYMENT', 'A new invoice arrived to your payments' . NEW_LINE);
?>
