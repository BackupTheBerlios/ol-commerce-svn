<?php
/* -----------------------------------------------------------------------------------------
   $Id: gv_queue.php,v 2.0.0 2006/12/14 05:48:38 gswkaiser Exp $
...
define('TEXT_REDEEM_COUPON_MESSAGE_HEADER', 'You recently purchased a Gift Voucher from our online store.' . NEW_LINE
                                          . 'For security reasons this was not made immediately available to you.' . NEW_LINE
                                          . 'However this amount has now been released. You can now visit our store' . NEW_LINE
