<?php
/* --------------------------------------------------------------
   $Id: categories.php,v 2.0.0 2006/12/14 05:48:31 gswkaiser Exp $
...
define('TEXT_EXISTING_PRODUCT', 'Product %s');
define('TEXT_NEW_PRODUCT', 'New '.TEXT_EXISTING_PRODUCT);
...
define('TEXT_PRODUCTS_AUCTION_DESCRIPTION', 'Auction Description:');
...
$error='Error: The catalog images directory \'images\' ';
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', $error.'is not writeable!');
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', $error.'does not exist!');
