...
=======
$Id: english.php,v 1.1.1.2 2006/12/23 11:23:41 gswkaiser Exp $
>>>>>>> 1.1.1.2
...
if (!defined('DATE_FORMAT_SHORT'))
{
	...
	//define('PRICE_DISCLAIMER_SHIPMENT_COST_TEXT','Shipping cost (from %s'.RPAREN);
	define('PRICE_DISCLAIMER_SHIPMENT_COST','Shipping cost'.RPAREN);
	...
	define('PRICE_DISCLAIMER_COMMON',' plus <a href="'.$price_info.'" title="Detailed information on shipping costs you will find here with one "Click"!><u>'.
