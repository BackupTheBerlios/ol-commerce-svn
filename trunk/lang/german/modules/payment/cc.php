...
define('MODULE_PAYMENT_CC_TEXT_DESCRIPTION', 'Kreditkarte Testinfo:<br/><br/>CC#: 4111111111111111<br/>Gültig bis: Jederzeit');
...
define('MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_EXPIRES', 'Kreditkarten-Gültigkeitsdatum:');
...
define('MODULE_PAYMENT_CC_TEXT_JS_CC_CVV', 'Der CVV Sicherheitscode ist ein Pflichtfeld und muss ausgefüllt werden..\n Bestellungen können ohne diesen Code nicht ausgeführt werden.\n Der CVV Code besteht aus 3 Ziffern und ist im Unterschriftsfeld auf der Rückseite Ihrer Karte gedruckt.');
define('MODULE_PAYMENT_CC_TEXT_CVV_LINK', '<u>[Hilfe?]</u>');
define('HEADING_CVV', 'Sicherheitscode Infoseite');
define('TEXT_CVV', '<table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="tableHeading"><b>Visa, Mastercard, Discover und Andere mit 3-stelligem CVV-Code</b></span></td></tr><tr><td><span class="boxText">Für Ihre eigene Sicherheit ist die Angabe Ihres Sicherheitscodes verpflichtend. Die Sicherheitsnummer ist eine 3stellige Nummer, die im Unterschriftsfeld auf der Rückseite Ihrer Kreditkarte gedruckt ist. Sie erscheint nach den letzten vier Stellen Ihrer Kartennummer auf der rechten Seite.</span></td></tr><tr><td align="center"><img src="images/cv_card.gif"></td></tr></table><hr/><table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="main"><b>American Express 4-stelliger CVV-Code</b> </span></td></tr><tr><td><span class="boxText">Für Ihre eigene Sicherheit ist die Angabe Ihres Sicherheitscodes verpflichtend. Der American Express Sicherheitscode ist eine 4-stellige Nummer auf Ihrer Kartenvorderseite. Sie erscheint nach den letzten vier Stellen Ihrer Kartennummer auf der rechten Seite.</span></td></tr><tr><td align="center"><img src="images/cv_amex_card.gif"></td></tr></table>');
//  define('TEXT_CLOSE_WINDOW', '<u>Fenster schliessen</u> [x]');

define('MODULE_PAYMENT_CC_STATUS_TITLE', 'Kreditkartenmodul aktivieren');
define('MODULE_PAYMENT_CC_STATUS_DESC', 'Möchten Sie Zahlungen per Kreditkarte akzeptieren?');
define('MODULE_PAYMENT_CC_ALLOWED_TITLE' , 'Erlaubte Zonen');
define('MODULE_PAYMENT_CC_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, welche für dieses Modul erlaubt sein sollen. (z.B. AT,DE (wenn leer, werden alle Zonen erlaubt))');
define('CC_VAL_TITLE', 'Kartenüberprüfung einschalten');
define('CC_VAL_DESC', 'Möchten Sie die Kreditkartenangaben überprüfen und Karten identifizieren?');
define('CC_BLACK_TITLE', 'KK-Blackliste aktivieren');
define('CC_BLACK_DESC', 'Möchten Sie die KK-Blackliste aktivieren, um dort hinterlegte Kreditkarten abzulehnen?');
define('CC_ENC_TITLE', 'Kreditkarteninfo verschlüsseln');
define('CC_ENC_DESC', 'Möchten Sie Kreditkarteninfos verschlüsseln?');
...
define('USE_CC_CVV_DESC', 'Möchten Sie die CVV Nummer aufnehmen?');
define('USE_CC_ISS_TITLE', 'Vorgangsnummer hinterlegen');
define('USE_CC_ISS_DESC', 'Möchten Sie die Vorgangsnummer aufnehmen?');
define('USE_CC_START_TITLE', 'Startdatum hinterlegen');
define('USE_CC_START_DESC', 'Möchten Sie das Startdatums aufnehmen?');
define('CC_CVV_MIN_LENGTH_TITLE', 'Länge der CVV Nummer');
define('CC_CVV_MIN_LENGTH_DESC', 'Länge der CVV angeben. Der Standard ist 3 und sollte nicht geändert werden, bis ein neuer Industrie-Standard ausgegeben wurde.');
define('MODULE_PAYMENT_CC_EMAIL_TITLE', 'Kartensplit eMail Adresse');
define('MODULE_PAYMENT_CC_EMAIL_DESC', 'Wenn eine eMailadresse angegeben worden ist, werden die mittleren Ziffern der Kreditkarten Nummer an diese Adresse gesandt. (Die äusseren Ziffern werden in der Datenbank gespeichert, und die Mittleren darin werden zensiert.');
