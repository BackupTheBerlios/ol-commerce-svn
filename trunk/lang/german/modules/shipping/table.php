<?php
/* -----------------------------------------------------------------------------------------
   $Id: table.php,v 2.0.0 2006/12/14 05:49:44 gswkaiser Exp $
...
define('MODULE_SHIPPING_TABLE_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand möglich sein soll. (z.B. AT,DE (lassen Sie dieses Feld leer, wenn Sie alle Zonen erlauben wollen))');
define('MODULE_SHIPPING_TABLE_COST_TITLE' , 'Versandkosten');
define('MODULE_SHIPPING_TABLE_COST_DESC' , 'Die Versandkosten basieren auf Gesamtkosten oder Gesamtgewicht der bestellten Waren. Beispiel: 25:5.50,50:8.50,etc.. Bis 25 werden 5.50 verrechnet, darüber bis 50 werden 8.50 verrechnet, etc');
...
define('MODULE_SHIPPING_TABLE_HANDLING_DESC' , MODULE_SHIPPING_TABLE_HANDLING_TITLE.' für diese Versandmethode');
...
define('MODULE_SHIPPING_TABLE_ZONE_DESC' , 'Wenn eine Zone ausgewählt ist, wird diese Versandmethode ausschliseslich für diese Zone angewendet');
