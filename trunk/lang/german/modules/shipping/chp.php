<?php
/* -----------------------------------------------------------------------------------------
   $Id: chp.php,v 2.0.0 2006/12/14 05:49:39 gswkaiser Exp $
...
define('MODULE_SHIPPING_CHP_INVALID_ZONE', 'Es ist leider kein Versand in dieses Land möglich');
define('MODULE_SHIPPING_CHP_UNDEFINED_RATE', 'Die Versandkosten können im Moment nicht errechnet werden');
...
define('MODULE_SHIPPING_CHP_HANDLING_TITLE' , 'Bearbeitungsgebühr');
define('MODULE_SHIPPING_CHP_HANDLING_DESC' , MODULE_SHIPPING_CHP_HANDLING_TITLE.' für diese Versandart in CHF');
