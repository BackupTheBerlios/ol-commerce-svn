<?php
/*------------------------------------------------------------------------------
   $Id: affiliate_affiliates.php,v 2.0.0 2006/12/14 05:49:13 gswkaiser Exp $
...
define('TEXT_INFO_NUMBER_OF_SALES', 'Anzahl der Verkäufe:');
define('TEXT_INFO_COUNTRY', 'Land:');
define('TEXT_INFO_SALES_TOTAL', 'Summe aller Verkäufe:');
define('TEXT_INFO_AFFILIATE_TOTAL', 'Provision:');
define('TEXT_DELETE_INTRO', 'Wollen Sie diesen Partner wirklich löschen?');
define('TEXT_INFO_HEADING_DELETE_CUSTOMER', 'Partner löschen');
...
define('ENTRY_AFFILIATE_PAYMENT_CHECK','Scheck für:');
...
define('CATEGORY_PAYMENT_DETAILS','Auszahlung erfolgt über:');
