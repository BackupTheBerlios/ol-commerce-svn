...
define('TEXT_EDIT_ADDRESS', 'Adressen bearbeiten oder einfügen');
define('TEXT_EDIT_PRODUCTS', 'Artikel bearbeiten oder einfügen');
define('TEXT_EDIT_SHIPPING', 'Versandkosten bearbeiten oder einfügen');
...
define('TEXT_INS', 'Hinzufügen:');
define('TEXT_SHIPPING', 'Versandkosten');
define('TEXT_COD_COSTS', 'Nachnahmegebühr');
