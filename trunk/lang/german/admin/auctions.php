<?php
/* --------------------------------------------------------------
$Id: auctions.php,v 1.2 2006/12/14 18:03:47 gswkaiser Exp $
...
define('AUCTIONS_LIST_ERROR_NO_TEMPLATE','Keine Auktionsvorlage vorhanden in Verzeichnis "');
...
define('AUCTIONS_LIST_ERROR_PIC_IMAGE_TEXT',DOT.' Bild ');
...
define('AUCTIONS_TEXT_AUCTION_CAT2','Zweite Kategorie (<b>Doppelte Gebühren<b>)');
