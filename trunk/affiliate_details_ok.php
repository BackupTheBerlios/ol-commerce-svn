<?php
/*------------------------------------------------------------------------------
   $Id: affiliate_details_ok.php,v 1.1.1.1.2.1 2007/04/08 07:16:04 gswkaiser Exp $
...
$breadcrumb->add(NAVBAR_TITLE_DETAILS_OK, olc_href_link(FILENAME_AFFILIATE_DETAILS_OK));

require(DIR_WS_INCLUDES . 'header.php');

$smarty->assign('LINK_SUMMARY', HTML_A_START . olc_href_link(FILENAME_AFFILIATE_SUMMARY) . '">' . olc_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . HTML_A_END);
$main_content=$smarty->fetch(CURRENT_TEMPLATE_MODULE . 'affiliate_details_ok'.HTML_EXT,SMARTY_CACHE_ID);
