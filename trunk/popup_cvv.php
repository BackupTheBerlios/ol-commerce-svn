<?php
/*------------------------------------------------------------------------------
  $Id: popup_cvv.php,v 1.1.1.1.2.1 2007/04/08 07:16:18 gswkaiser Exp $
...
------------------------------------------------------------------------------*/
  ...
  require(DIR_WS_LANGUAGES . SESSION_LANGUAGE . '/' . modules . '/' . payment . '/' . 'cc.php');
?>
...
<p class="smallText" align="right"><?php echo '<a href="javascript:window.close()">' . TEXT_CLOSE_WINDOW . HTML_A_END; ?></p>
