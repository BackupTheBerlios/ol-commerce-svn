<?php
/* --------------------------------------------------------------
   $Id: email.php,v 1.1.1.1.2.1 2007/04/08 07:17:46 gswkaiser Exp $   
...
(c) 2004      XT - Commerce; www.xt-commerce.com
  ...
  // include functions
  require_once(DIR_FS_INC.'olc_convert_linefeeds.inc.php');
 ...
 */
    ...
    function add_text($text = '') {
      $this->text = olc_convert_linefeeds(array("\r\n", NEW_LINE, "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = olc_convert_linefeeds(array("\r\n", NEW_LINE, "\r"), HTML_BR, $html);
      $this->html_text = olc_convert_linefeeds(array("\r\n", NEW_LINE, "\r"), $this->lf, $text);
