<?php
/* -----------------------------------------------------------------------------------------
   $Id: http_client.php,v 1.1.1.1.2.1 2007/04/08 07:17:46 gswkaiser Exp $   
 ...
 **/
    function Connect($host, $port = '') {
      ...
      $this->url['host'] = $host;
      if (olc_not_null($port)) $this->url['port'] = $port;
