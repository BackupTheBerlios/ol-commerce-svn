<?php
/*
  $Id: TransactionDetails.inc.php,v 1.1.1.1.2.1 2007/04/08 07:18:07 gswkaiser Exp $
...
<tr>
  <td width="150"><?php echo olc_image($pixel,'','150','1'); ?></td>
  <td width="6"><?php echo olc_image($pixel,'','6','1'); ?></td>
  <td width="100%"><?php echo olc_image($pixel,'','432','1'); ?></td>
</tr>
<tr>
  <td colspan="3">
...
<?php if($paypal->info['for_auction'] === TRUE_STRING_S) { ?>
<tr valign="top">
