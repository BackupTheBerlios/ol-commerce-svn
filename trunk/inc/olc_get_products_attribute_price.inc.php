<?php
/* -----------------------------------------------------------------------------------------
   $Id: olc_get_products_attribute_price.inc.php,v 1.1.1.1.2.1 2007/04/08 07:17:31 gswkaiser Exp $   
   ...
   -----------------------------------------------------------------------------------------
   based on:
   (c) 2003	    nextcommerce (olc_get_products_attribute_price.inc.php,v 1.8 2003/08/14); www.nextcommerce.org
