<?php
/* -----------------------------------------------------------------------------------------
$Id: olc_check_agent.inc.php,v 1.1.1.1.2.1 2007/04/08 07:17:10 gswkaiser Exp $
...
function olc_check_agent()
{
	if (CHECK_CLIENT_AGENT==TRUE_STRING_S)
	{
		$Robots = array (
		"antibot",
		"appie",
		...
		return in_array(strtolower($_SERVER['HTTP_USER_AGENT']),$Robots);
		/*
