<?php
/* -----------------------------------------------------------------------------------------
$Id: olc_get_short_description.inc.php,v 1.1.1.1.2.1 2007/04/08 07:17:33 gswkaiser Exp $
...
function olc_get_short_description($product_id, $language = '') {
	...
	$product_query = olc_db_query("select products_short_description from " . TABLE_PRODUCTS_DESCRIPTION .
