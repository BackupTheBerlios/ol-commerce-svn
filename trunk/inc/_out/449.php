<?php
/* -----------------------------------------------------------------------------------------
$Id: olc_validate_email.inc.php,v 1.1.1.1.2.1 2007/04/08 07:17:42 gswkaiser Exp $
...
(c) 2003	    nextcommerce (olc_validate_email.inc.php,v 1.5 2003/08/14); www.nextcommerce.org
...
function olc_validate_email($email) {
	...
	if ($valid_address) {
		if (ENTRY_EMAIL_ADDRESS_CHECK == TRUE_STRING_S) {
